...
const HeroSection = () => {
  return (
    <div className="min-h-[986px] w-full relative overflow-hidden">
      ...
      <div className='relative max-w-[1440px] text-center mx-auto w-full md:w-[70%] xl:w-[55%] flex flex-col justify-center items-center gap-[40px] py-[30px] md:py-[66px]'>
        <div className='flex justify-center items-center gap-3'>
          <Image src="/images/home/img1.svg" width={46} height={30} alt='img icon' />
        ...
        <div className='flex flex-col md:flex-row justify-center items-center gap-4'>
          <input type="email" placeholder='Enter your email' className='w-[340px] h-[48px] rounded-[10px] border border-[#E3E3E8] shadow-xs bg-white outline-0 px-3' />
          <button className='w-[239px] h-[48px] rounded-[10px] shadow-xs cursor-pointer bg-[#000000] text-white flex justify-center items-center gap-3'>Get Stock Ideas for Free <TiArrowRight className='text-xl' /> </button>
        </div>
        <Image src="/images/home/img2.svg" width={300} height={307} alt='mobile img' />
