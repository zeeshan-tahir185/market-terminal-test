...
const SecondHero = () => {
  return (
    <div className="md:min-h-[800px] w-full relative overflow-hidden">
      ...
      <div className='relative max-w-[1440px] text-center mx-auto w-full flex flex-col justify-center items-center gap-[20px] md:gap-[70px] py-[30px] md:py-[66px] px-[30px]'>
