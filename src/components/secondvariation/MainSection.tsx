...
const MainSection = () => {
    return (
        <div className='flex flex-col gap-[25px] md:gap-[50px] max-w-[1440px] mx-auto my-[50px] md:my-[140px] px-[30px] main_section_background'>
            ...
            <div className='flex flex-col gap-[40px] md:gap-[70px]'>
                <div className='flex flex-col relative'>
                    <div className='w-[100%] md:w-[70%] mx-auto flex flex-col items-center'>
                        ...
                        <Image src="/images/home/img3.webp" width={930} height={480} alt='first graph' />
                    </div>
                ...
                <div className='flex flex-col gap-[40px] md:gap-[100px]'>
                    <div className='w-[100%] md:w-[70%] mx-auto flex flex-col items-center'>
                        ...
                        <Image src="/images/home/img5.webp" width={930} height={480} alt='first graph' />
                    </div>
                </div>
            </div>
            ...
            <div className='flex flex-col lg:flex-row items-center justify-center gap-4 w-[100%] md:w-[80%] xl:w-[60%] mx-auto relative'>
                <img src="/images/home/img7.png" alt="" className='mr-2  w-[56px] h-[35px]' />
                <input
                    type="email"
                ...
                <button className='w-[70%] text-sm md:text-base mx-auto lg:mx-0 lg:w-[232px] xl:w-[239px] h-[48px] rounded-[10px] shadow-xs cursor-pointer bg-[#000000] text-white flex justify-center items-center gap-3'>
                    Get Breakouts for FREE <GoArrowRight className='text-xl' />
                </button>
                <img src="/images/home/img6.png" alt="" className='ml-2  w-[56px] h-[35px]' />
            </div>
        </div>
